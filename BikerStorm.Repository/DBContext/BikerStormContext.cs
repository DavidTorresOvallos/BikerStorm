...
namespace BikerStorm.Repository.DBContext;

public partial class BikerStormContext : DbContext
{
    public BikerStormContext()
    {
    }

    public BikerStormContext(DbContextOptions<BikerStormContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<RolMan> RolMen { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C7B481BD4");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F6FF9E6F1");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4832FB9A61C");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1076D02FBBE");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EED698A22");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13216CCB81D");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F761FE3D254");
        ...
        modelBuilder.Entity<RolMan>(entity =>
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMen__CD2045D83BFCD7E3");
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMen)
                .HasForeignKey(d => d.IdMenu)
                .HasConstraintName("FK__RolMen__idMenu__3F466844");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMen)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMen__idRol__3E52440B");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEF95210B1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6F4964A86");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614527969F5");
